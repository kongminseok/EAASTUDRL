...
def train_ACKTR(env_train, model_name, timesteps=50000):
    ...
    model.save(f"{config_dji.TRAINED_MODEL_DIR}/dji_{model_name}")
...
def DRL_prediction(df,
    ...
    ## trading env
    trade_data = data_split(df, start=unique_trade_date[iter_num - rebalance_window], end=unique_trade_date[iter_num]+1)
