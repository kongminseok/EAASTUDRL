...
class StockEnvValidation(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            plt.savefig('{}/account_value_validation_{}.png'.format(RESULT, self.iteration))
            plt.close()
            df_total_value = pd.DataFrame(self.asset_memory)
            df_total_value.to_csv('{}/account_value_validation_{}.csv'.format(RESULT, self.iteration))
