...
INITIAL_ACCOUNT_BALANCE=1000000 * 1000 # 환율 $1 =1,000원으로 설정
...
class StockEnvTrade(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            plt.savefig('{}/account_value_trade_{}_{}.png'.format(RESULT, self.model_name, self.iteration))
            plt.close()
            df_total_value = pd.DataFrame(self.asset_memory)
            df_total_value.to_csv('{}/account_value_trade_{}_{}.csv'.format(RESULT, self.model_name, self.iteration))
            ...
            df_rewards.to_csv('{}/account_rewards_trade_{}_{}.csv'.format(RESULT, self.model_name, self.iteration))
